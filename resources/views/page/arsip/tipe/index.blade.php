...
@section('content')
    ...
    <x-arsip-tabs active="tipe" />


    <div class="d-flex justify-content-between align-items-center">
        <x-head-index :title="$title" />
        <x-btn-add :href="route('arsip.tipe.create')" title="Tambah Tipe" />
    </div>
            ...
            <table class="table" id="datatable">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th class="text-white" style="width: 350px;">Kategori</th>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('arsip.tipe.edit', $item->id) }}"><i
                                                class="bx bx-edit-alt me-1"></i>
                                            Edit</a>

                                        <x-delete id="deleteTipe{{ $item->id }}"
                                            action="{{ route('arsip.tipe.destroy', $item->id) }}"
                                            message="Yakin ingin menghapus tipe ini?" />
                                    </div>
                                </div>
                            </td>
                        </tr>
